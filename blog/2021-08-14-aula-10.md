...
Finalizamos a manha até esse ponto, e no período da tarde voltamos vendo a parte de *selects* com o material do [link](https://docs.google.com/presentation/d/1sZoznJP4HaDXseo5S0_COBhVv_zRQfsMRKUGSZ7nFSg/edit). Vimos os tipos de join, e como fazer um *join* entre tabelas, como utilizar o *group by* e como utilizar o *order by* e por fim, o *limit*.
